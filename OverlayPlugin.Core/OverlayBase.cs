...
namespace RainbowMage.OverlayPlugin
{
        ...
        where TConfig: OverlayConfigBase
    {
        ...
        {
            Overlay.LatestBitmap?.Save(Path.Combine(path, string.Format("{0}{1}{2}", "ScreenShot_", DateTime.Now.ToString("yyyy-MM-dd-HH-mm-ss-fff"), ".png")), System.Drawing.Imaging.ImageFormat.Png);
        }
    }
}
