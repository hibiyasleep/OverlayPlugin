...
namespace RainbowMage.OverlayPlugin
{
    internal static class Utility
    {
        ...
        {
            int ex = NativeMethods_Copy.GetWindowLong(form.Handle, NativeMethods_Copy.GWL_EXSTYLE);
            ex |= NativeMethods_Copy.WS_EX_TOOLWINDOW;
            NativeMethods_Copy.SetWindowLongA(form.Handle, NativeMethods_Copy.GWL_EXSTYLE, (IntPtr)ex);
        }
